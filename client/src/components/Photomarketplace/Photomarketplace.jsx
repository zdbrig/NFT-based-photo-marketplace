...
export default class Photomarketplace extends Component {
    ...
    addReputation = async () => {
        ...
        let _to2 = accounts[0];
        let _tokenId2 = 1;
        const response_1 = await photoNFTMarketplace.methods
            .reputation(_from2, _to2, _tokenId2)
            .send({ from: accounts[0] });
        console.log("=== response of reputation function ===", response_1); // Debug

        const response_2 = await photoNFTMarketplace.methods
            .getReputationCount(_tokenId2)
            .call();
        console.log(
            "=== response of getReputationCount function ===",
            response_2
        ); // Debug
    };
