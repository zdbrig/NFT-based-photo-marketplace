        ...
        <div className="header">
            ...
            <div className="row">
                <div className="col-6 logo">
                    {" "}
                    <img src={nftlogo} alt="logo nova" className="logo" />
                </div>
                {showConnect ? (
                    !showInput ? (
                        <button
                        ...
                        <div className="col-3  buttonConnect ">
                            <button className="account">
                                <i className="fa fa-circle text-success"></i>{" "}
                                {account}
                               
                            </button> 
                            <button className="account" onClick={()=>logout()}><img style={{height: "46px"}} src={logoutLogo}/></button>
