                        ...
                        <div className="col-12">
                            <div className="main__title main__title--page">
                                ...
                                <p>
                                    ...
                                    <a href="#">web page</a> editors now use
                                    Lorem Ipsum as their default model text, and
                                ...
                                <p>
                                    ...
                                    <b>Internet</b> tend to repeat predefined
                                ...
                                <ol>
                                    ...
                                    <li>
                                        <h4>
                                            Reasons for collecting and
                                            processing user personal information
                                        </h4>
                                        <ol>
                                            <li>
