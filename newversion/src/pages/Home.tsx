...
import Hometopseller from "../component/Home/Hometopseller";
                    ...
                    <div className="row row--grid">
                        ...
                        <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div className="feature">
                                ...
                                <p className="feature__text">
                                    ...
                                    connect it to NFT marketplace by clicking
                                    this link. <br />
                        ...
                        <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div className="feature">
                                ...
                                <p className="feature__text">
                                    ...
                                    banner images, and set a secondary sales
                                    fee.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div className="feature">
                                ...
                                <p className="feature__text">
                                    Upload your work, add a title and
                        ...
                        <div className="col-12 col-md-6 col-lg-4 col-xl-3">
                            <div className="feature feature--last">
                                ...
                                <p className="feature__text">
                                    ...
                                    choose how you want to sell your NFTs, and
