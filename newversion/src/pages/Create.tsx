  ...
  const createItem = async () => {
    ipfs.files.add(buffer, (error: any, result: any) => {
      ...
      photoNFTFactory.methods
        .createNewPhotoNFT(namePhoto, description, price, result[0].hash)
          ...
          photoNFT.methods
            ...
            .once("receipt", (receipt: any) => {
              ...
              photoNFTMarketplace.methods
                .openTradeWhenCreateNewPhotoNFT(PHOTO_NFT, photoId, price)
                .send({ from: accounts[0] })
                .once("receipt", (receipt: any) => {
                  setLoading(false);
                });
                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    <div className="sign__file">
                      <label id="file1" htmlFor="sign__file-upload"></label>
                      <input
                        data-name="#file1"
                  ...
                  <div className="col-12 col-xl-3">
                    <button
                      type="button"
                      className={
                        buttonActive === false ? "sign__btn" : "btnItem"
                      }
                      onClick={createItem}
