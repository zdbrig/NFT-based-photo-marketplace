    ...
    return (
        <div className="asset__item  assetPhoto">
            {props.photo !== undefined && (
                <object
                    data={`https://ipfs.io/ipfs/${props.photo}`}
                    // height="300"
                    // width="260"
                    className="imgItem"
                    // scrolling="no"
            ...
            {/* <a
                ...
                href={`https://ipfs.io/ipfs/${props.photo}`}
            >
                <img src={`https://ipfs.io/ipfs/${props.photo}`} alt="" />
            </a>
            <video width="500" height="250" controls>
                <source
                    src={`https://ipfs.io/ipfs/${props.photo}`}
                    type="video/mp4"
                />
            </video> */}
            {/* <!-- share --> */}
            <div className="share share--asset">
                <FacebookShareButton
                    ...
                    className="share__link share__link--fb fb"
                >
                    {" "}
                    <svg
                        width="9"
                ...
                {/* <div
                    ...
                    data-href="https://www.facebook.com/sqoin/"
