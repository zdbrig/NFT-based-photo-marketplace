...
export class NFTBorder extends ethereum.SmartContract {
  static bind(address: Address): NFTBorder {
    return new NFTBorder("NFTBorder", address);
  }
  ...
  createNewPhotoNFT(
    ...
    let result = super.call(
      "createNewPhotoNFT",
      "createNewPhotoNFT(string,string,uint256,string,string,uint256):(bool)",
      [
        ...
        ethereum.Value.fromString(addresEmail),
        ethereum.Value.fromUnsignedBigInt(redevance)
      ]
    );
