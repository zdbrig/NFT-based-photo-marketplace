...
function Activitycomponent() {
  ...
  const connectContract = async () => {
    ...
    let PhotoNFTMarketplace = require("../../build/contracts/PhotoNFTMarketplace.json");

    let PhotoNFTData = require("../../build/contracts/PhotoNFTData.json");
                ...
                <div className="activity">
                  ...
                  <div className="activity__content">
                    <h3 className="activity__title">
                      <a href="#/Item">{photo.photoNFTSymbol}</a>
                    </h3>
                    <p className="activity__text">
                      listed by <a href="#/Author">{photo.photoNFTName}</a>{" "}
                      <br />
